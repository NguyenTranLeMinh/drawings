...
with DAG("user_processing", 
    ...
    # Task 1:  tạo các Table trong Database.
    ...
    # Task 2: kiểm tra xem API hiện còn hoạt động không
    is_api_available = HttpSensor(
        task_id='is_api_available',
        http_conn_id='user_api',
        endpoint='api/'
    )
    # Task 3:  trích xuất dữ liệu với SimpleHttpOperator
    ...
    # Task 4: xử ý dữ liệu với PythonOperator
